...
public class PromissoryExportForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PromissoryExportForm frame = new PromissoryExportForm();
	...
	public PromissoryExportForm() {
		...
		JLabel lblPhiuXutHng = new JLabel("PHI\u1EBEU XU\u1EA4T H\u00C0NG");
		...
		JLabel lblPhieuxuat = new JLabel("M\u00E3 phi\u1EBFu xu\u1EA5t");
		...
		btnThem.setIcon(new ImageIcon(PromissoryExportForm.class.getResource("/img/ic_add.png")));
		btnThem.setBounds(34, 367, 164, 42);
		panel2.add(btnThem);
		
		JButton btnLuu = new JButton("L\u01B0u");
		btnLuu.setIcon(new ImageIcon(PromissoryExportForm.class.getResource("/img/ic_save.png")));
		btnLuu.setBounds(224, 367, 106, 42);
		panel2.add(btnLuu);
		
		JButton btnHuy = new JButton("H\u1EE7y h\u00F3a \u0111\u01A1n");
		btnHuy.setIcon(new ImageIcon(PromissoryExportForm.class.getResource("/img/ic_delete.png")));
		btnHuy.setBounds(355, 367, 139, 42);
		panel2.add(btnHuy);
		
		JButton btnIn = new JButton("In h\u00F3a \u0111\u01A1n");
		btnIn.setIcon(new ImageIcon(PromissoryExportForm.class.getResource("/img/ic_printf.png")));
		...
		btnDong.setIcon(new ImageIcon(PromissoryExportForm.class.getResource("/img/ic_off.png")));
